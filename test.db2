...
*--------------------------------------------------------------------------------------------------------------------------------------------------------
*< FOXBIN2PRG: Version="1.19" SourceFile="C:\DESA\test2\test.dbf" /> (Solo para binarios VFP 9 / Only for VFP 9 binaries)
*

<TABLE>
	<MemoFile></MemoFile>
	<CodePage>1252</CodePage>
	<LastUpdate>2014/02/20</LastUpdate>
	<Database></Database>
	...
	<indexFile>C:\DESA\TEST2\TEST.CDX</indexFile>

	<INDEXES>
		<INDEX>
			<TagName>APELLIDO</TagName>
